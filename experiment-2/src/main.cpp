...
#include "src/experimentTwo_IDL.h"
...
/**
 * @brief The experimentTwo class provides a wrapper for the superquadric
 ...
 */
class experimentTwo : public RFModule,
                    experimentTwo_IDL
{
...
public:
    ...
    */
    ...
    bool configure(ResourceFinder &rf)
    {
        ...
        portBlobRpc.open("/experiment-2/blob:rpc");
        portOPCrpc.open("/experiment-2/OPC:rpc");
        portSFMRpc.open("/experiment-2/SFM:rpc");
        superqRpc.open("/experiment-2/superq:rpc");
        graspRpc.open("/experiment-2/grasp:rpc");
        portRpc.open("/experiment-2/rpc");
        portImgIn.open("/experiment-2/img:i");
...
int main(int argc,char *argv[])
{
    ...
    experimentTwo mod;
    ResourceFinder rf;
    rf.setDefaultContext("experiment-2");
